    ...
    const fetchData = async (username, authtoken) => {
      try {
        const response = await fetch(
          `http://127.0.0.1:4000/seller/courses/${username}`,
          {
            method: "GET",
            headers: {
    ...
    <div>
      ...
      <center>
        <div className={style.EditForm}>
          ...
          <div>
            <TextField className={style.i1} 
              id="standard-basic" 
              label="Course Name" 
              variant="standard" 
              onChange={(e) => setname(e.target.value)}
            />
            <TextField className={style.i2} 
              id="standard-basic" 
              label="Cost" 
              variant="standard" 
            ...
            />
            <button className={style.pushb} onClick={editCourse}> Push Edit </button>
            ...
            {courses.map((item) => (
              ...
              >
                ...
                <div className="coursedetails">
                  ...
                  <button className={style.edt} onClick={() => handleEdit(item.courseId)}>Edit</button>
                </div>
              </div>
            ))}
          </div>
